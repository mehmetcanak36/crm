...
function addTable($cname,$lastname,$email,$adres,$managerid,$departmentid){
    $conn=connect();
    $query="INSERT INTO customer(cName,cLastName,cEmail,cAddress,manager_id,department_id)
    VALUE('$cname','$lastname','$email','$adres','$managerid','$departmentid')";
    $data=mysqli_query($conn,$query);
}
